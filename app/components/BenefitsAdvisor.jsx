...
import planDataJson from "../../plan-data/current-plans.json";

// ─── PLAN DATA (loaded from plan-data/current-plans.json) ────
const PREMIUMS_BIWEEKLY = planDataJson.premiumsBiweekly;
const HSA_EMPLOYER = planDataJson.hsaEmployer;
const PLANS = planDataJson.plans;
const AVG_COSTS = planDataJson.avgCosts;
const PLAN_YEAR = planDataJson._meta?.planYear || "";
